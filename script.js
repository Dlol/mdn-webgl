...
function main() {
  ...
  `;
	...
	shader.initShaderProgram(vsSource, fsSource);

	shader.addAttribLoc("vertexPosition", "aVertexPosition");
	shader.addUniformLoc("projectionMatrix", "uProjectionMatrix");
	shader.addUniformLoc("viewMatrix", "uViewMatrix");
	shader.addUniformLoc("modelMatrix", "uModelMatrix");
	shader.addUniformLoc("color", "uColor");
	console.log(shader.programInfo);
	...
	// Draw the scene
	drawScene(canvas.gl, shader.programInfo, buffers);
}
